...
### Summary
Locqar v1 is a mobile application that helps users find and book locations. It is a software solution that helps users find and book locations, from ordering and inventory to customer service and reporting.
